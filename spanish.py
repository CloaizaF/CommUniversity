...
class Spanish:
	...
	"lo": "\t\tRegresa pronto.",
	"np": "\t\tNo tienes permiso para realizar esta accion.",
	"ub": "\t\tTu usuario actualmente esta excluido, por lo tanto, no puedes ingresar.",
	"ub1": "\t\tUsuario expulsado.",
	"unub": "\t\tUsuario reintegrado.",
	"inub": "\t\tIngresa el usuario que sera expulsado.",
	"inunb": "\t\tIngresa el usuario que sera reintegrado.",
	"chd": "\t\tCanal eliminado.",
	"qd": "\t\tPregunta eliminada.",
	"cod": "\t\tComentario eliminado.",
	"nd": "\t\tnoticia eliminada.",
	"aam": "\t\tEsta accion ya se ha realizado una vez, por lo tanto, no se puede realizar de nuevo.",
	"ara": "\t\tEsta accion requiere que la accion 4 sea realizada.",
	"nusers": "\t\tNo hay usuarios.",
	"redirecting": "\t\tRedireccionandote al menu anterior.",
	"idmb": "\t\tEl id debe ser un numero entero.", 
	"inputtabs": "\t\t",
	"uab": "\t\tEl usuario ya esta expulsado.",
	"unb": "\t\tEste usuario no esta expulsado.",
	"proupd": "\t\tPerfil actualizado.",
	"usupd": "\t\tNombre de usuario actualizado.",
	"nupd": "\t\tNombre actualizado.",
	"pupd": "\t\tContrasena actualizada.",
	...
	"labelupd": "\t\tCategoria actualizada.",
